...
public class Frame4 implements ActionListener {
	...
	Frame4(){
		...
		op1 = new JButton("a) Junagarh, Gujarat");
		op2 = new JButton("b) Diphu, Assam");
		op3 = new JButton("c) Kohima, Nagaland");
		op4 = new JButton("d) Gangtok, Sikkim");
		next = new JButton("Next");
		prev = new JButton("Previous");
		l1 = new JLabel("4.Garampani sanctuary is located at");
